...
python YUZU_TESTER.py         # 541 tests, ~19 seconds
...
| **Measure her** | |
| `YUZU_TESTER.py` | Test suite. 541 tests. `--shuffle` catches test pollution |
...
| `ui/home.html` | The home screen. Tap a tile, it opens |
| **Read these** | |
